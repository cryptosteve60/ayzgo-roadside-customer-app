      ...
      <Card className="rounded-t-3xl border-0 shadow-2xl">
        <div className="p-6">
          ...
          <div className="relative mb-6">
            <Input placeholder="Enter pickup location" value={searchLocation} onChange={e => setSearchLocation(e.target.value)} className="pl-10 h-12 text-lg" />
          ...
          <div className="mb-6">
            <div className="grid grid-cols-1 gap-3">
              {services.map(service => <Button key={service.type} variant="outline" className="h-auto p-4 flex justify-between items-center text-left" onClick={() => handleServiceSelect(service.type)}>
                  ...
                  <div className="text-right">
                    ...
                    <Badge className={`text-xs ${getAvailabilityColor(service.availability)}`} variant="secondary">
